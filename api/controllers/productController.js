...
var productController = {
    ...
    addedProductPage: function (req, res) {
        ...
        productController.createProduct(data, function (err, data) {
            if (err) {
                return res.send(err);
            }
            sails.controllers.productspecific.mockProductSpecific(data, function (categoriesData) {
                if (err) {
                    callback(err);
                    return;
                }
    ...
    listProducts: function (brand, callback) {
        product.find({brand: brand}, function (err, result) {
